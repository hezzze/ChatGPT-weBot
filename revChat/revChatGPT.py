...
# BASE_URL = environ.get("CHATGPT_BASE_URL") or "http://10.0.2.2:5000/"
# BASE_URL = "https://chat.duti.tech/"
BASE_URL = "https://server.chatgpt.yt/"
OPENAI_PROXY = "http://10.0.2.2:8001"
# OPENAI_PROXY = ""
...
def configure():
    ...
    """
    config_files = [".config/revChatGPT/config.json"]
