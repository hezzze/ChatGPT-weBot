...
from revChat.utils import create_completer
from revChat.utils import create_session
from revChat.utils import DataCollector
from revChat.utils import get_input
...
def configure():
    ...
    """
    config_files = [".config/revChatGPT/config.json", "config.json"]
